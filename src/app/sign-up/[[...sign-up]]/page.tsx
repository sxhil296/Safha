    ...
    <div className="grid w-full flex-grow items-center min-h-screen px-4 sm:justify-center">
      <SignUp.Root>
        ...
        >
          ...
          <SignUp.Action
            submit
            className="w-full rounded-md bg-zinc-950 px-3.5 py-1.5 text-center text-sm font-medium shadow outline-none ring-1 ring-inset ring-zinc-950 hover:bg-zinc-800 focus-visible:outline-[1.5px] focus-visible:outline-offset-2 focus-visible:outline-zinc-950 "
          >
            Continue
          </SignUp.Action>
          <p className="text-center text-sm text-zinc-500">
