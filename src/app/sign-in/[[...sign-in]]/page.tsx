...
export default function SignInPage() {
  return (
    <div className="grid w-full flex-grow items-center  px-4 sm:justify-center min-h-screen">
      <SignIn.Root>
        <SignIn.Step
          name="start"
        ...
        >
          ...
          <header className="flex flex-col justify-center items-center">
            ...
            <h1 className="mt-4 text-lg font-normal tracking-tight ">
              Sign in to Safha
            </h1>
          </header>
          ...
          <Clerk.Field name="identifier">
            ...
            <Clerk.Input
              ...
              required
              placeholder="Email"
              className="w-full border-b border-neutral-600  p-2 rounded-md text-sm/6  outline-none placeholder:text-neutral-400 focus:border-neutral-200 data-[invalid]:border-red-600 data-[invalid]:text-red-600"
            />
