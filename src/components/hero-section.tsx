            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  ...
                  Safha is your space to share, discover, and explore books.
                  Upload your favorite PDFs, download new reads, and leave
                  reviews to help others find the best titles. Rate and upvote
                  books to shape the library. Join Safha – where every book
                  finds its reader.
                </TextEffect>
